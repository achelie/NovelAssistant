...
public class CharacterRelationServiceImpl
    ...
    @Override
    public List<CharacterRelation> listByCharacterId(Long characterId) {
        return list(new LambdaQueryWrapper<CharacterRelation>()
                .eq(CharacterRelation::getCharacterAId, characterId)
                .or()
                .eq(CharacterRelation::getCharacterBId, characterId));
    }
}
